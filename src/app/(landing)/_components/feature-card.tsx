...
export default function FeatureCard({ icon, title, description }: CardProps) {
  ...
  return (
    <Card
      className={cn(
        'group relative w-full overflow-hidden rounded-xl border border-muted-foreground/20 bg-gradient-to-r from-muted/20 to-card/30 shadow-[0_0_15px_rgba(49,49,49,0.2)] transition duration-300',
